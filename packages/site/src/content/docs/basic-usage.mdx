...
([`any`](/type-safe-errors/#any), [`allSettled`](/qa/#why-not-have-an-equivalent-of-promiseallsettled) and [`withResolvers`](/qa/#why-not-have-an-equivalent-of-promisewithresolvers) are discussed separately in these docs.)
