...
Laziness and automatic cancellation aside, LazyPromise API does not just resemble that of the native promise, but follows all its subtleties unless stated otherwise in the docs. This has a side benefit of making the library far easier to document and learn.
